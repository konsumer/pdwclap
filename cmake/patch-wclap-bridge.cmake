...
# Linux, WebKit.framework on macOS) — wclap~ never hosts a CLAP plugin's
# GUI, and a hard GTK/WebKit runtime dependency would keep the external
# from loading on a system without them. The include path gets pointed at
# src/vendor/webview-gui-stub instead (see CMakeLists.txt), a no-op
# stand-in with the same public API.
#
...
# Stop forwarding a loaded WCLAP's WASI stdout to Pd's own stdout.
...
# plugin (re)instantiation spams that straight into Pd's console. stderr
# stays inherited so real WASM traps/errors still surface.
